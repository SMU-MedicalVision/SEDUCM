function [S,V] = spDetect1( I, E, varargin )
...
if( type=='m' )
  % run watershed algorithm
    ...
    tempMask = imextendedmin(E,0.01);
    E = imimposemin(E,tempMask);
